...
USER_VECTORS_TABLE = os.environ.get(
    "USER_VECTORS_TABLE", "face-recognition-user-vectors-dev"
)
IMAGES_BUCKET = os.environ.get(
    "IMAGES_BUCKET", "face-recognition-images-dev-010438470467"
)
